...
<head>
    ...
    <link href="./web/css/navbar-top.css" rel="stylesheet">
    <link rel="stylesheet" href="./web/css/css" media="all">
  ...
  <script src="./web/js/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
  <script src="./web/js/bootstrap.min.js"></script>
  <script>window.jQuery || document.write('<script src="web/js/jquery-slim.min.js"><\/script>')</script>
  <script src="./web/js/popper.min.js"></script>
  

</body><div class="notranslate" style="position: absolute; top: 0; right:0;" id="vd-root-d19608294"></div></html>